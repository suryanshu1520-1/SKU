...
| [`news-intelligence-architecture.md`](file:///c:/Users/bentn/OneDrive/Desktop/SKU/docs/news-intelligence-architecture.md) | Zero-budget first-source intelligence engine architecture (multi-provider LLM, in-memory cosine dedup, finite daily editions) | `server-lib/llm.ts`, `server-lib/cron/ai.ts`, `server-lib/cron/pib-aggregator.ts` |
| [`continuous-readiness-architecture.md`](file:///c:/Users/bentn/OneDrive/Desktop/SKU/docs/continuous-readiness-architecture.md) | Active product north star: versioned verified claims, learn/replace mutations, learner checkpoints, Proof of Omission | Rebase migrations, `src/lib/rebase.ts`, `src/components/RebaseEdition.tsx` |
| [`voice-and-type-guide.md`](file:///c:/Users/bentn/OneDrive/Desktop/SKU/docs/voice-and-type-guide.md) | Standardized human lexicon and font assignment rules (Merriweather serif headers, Inter body, JetBrains Mono tags) | `src/components/`, `src/index.css` |
