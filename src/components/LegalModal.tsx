  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 md:px-6 py-12 relative">
      <motion.div
        ...
        className="bg-surface border border-border rounded-sm p-6 md:p-12 shadow-2xl relative"
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 md:top-6 md:right-6 p-2 text-muted hover:text-[#e0d0ab] transition-colors bg-surface-elevated/50 hover:bg-surface-elevated rounded-sm cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
...
function PrivacyPolicy() {
  return (
    <div className="space-y-6 text-secondary font-sans text-sm leading-relaxed">
      ...
      <p className="font-sans text-xs text-secondary">Effective Date: 2026-08-18 &bull; Platform: Tark (तर्क)</p>
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">1. INFORMATION WE COLLECT</h2>
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">2. ZERO DATA MONETIZATION PLEDGE</h2>
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">3. SECURITY & RETENTION</h2>
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">4. CONTACT</h2>
...
function TermsAndConditions() {
  return (
    <div className="space-y-6 text-secondary font-sans text-sm leading-relaxed">
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">1. PLATFORM INTEGRITY</h2>
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">2. FOUNDERS CLUB LIFETIME ACCESS</h2>
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">3. CONTACT</h2>
...
function RefundPolicy() {
  return (
    <div className="space-y-6 text-secondary font-sans text-sm leading-relaxed">
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">1. DIGITAL ACCESS & SEAT INVENTORY</h2>
      ...
      <h2 className="font-serif font-bold text-base text-primary mt-8 mb-3">2. TRANSACTION OR DEDUCTION ERRORS</h2>
