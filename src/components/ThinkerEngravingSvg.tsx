  ...
  return (
    <div className={`relative flex items-center justify-center select-none overflow-hidden ${className}`} style={style}>
      <style>{`
        ...
        @keyframes thinker-astrolabe-spin {
          from { transform: rotate(0deg); }
          to { transform: rotate(360deg); }
        }
        @keyframes thinker-pupil-glint {
          0%, 100% { opacity: 0.9; }
          50% { opacity: 1; filter: drop-shadow(0 0 2px #e0d0ab); }
        }
        .thinker-astrolabe-guides {
          transform-origin: 100px 100px;
          animation: thinker-astrolabe-spin 120s linear infinite;
        }
        .thinker-living-body {
          transform-origin: 100px 185px;
          animation: thinker-breathe 4.6s ease-in-out infinite;
        }
        .thinker-living-eyes {
          transform-origin: 100px 88px;
          animation: thinker-blink 4.2s ease-in-out infinite;
        }
        .thinker-pupil-glint {
          animation: thinker-pupil-glint 3.5s ease-in-out infinite;
        }
      ...
      {id === 'ambedkar' && (
        <svg viewBox="0 0 200 200" fill="none" className="w-full h-full block">
          <g stroke={resolvedStroke} opacity={resolvedGuideOpacity} strokeWidth="0.75" strokeDasharray="2 3" fill="none" className="thinker-astrolabe-guides">
          ...
          <g className="thinker-living-body">
            ...
            {/* Living Glasses & Blinking Eyes */}
            <g className="thinker-living-eyes" style={{ transformOrigin: '100px 88px' }}>
              ...
              <circle fill={resolvedAccent} cx="86" cy="88" r="2.2" className="thinker-pupil-glint" />
              <circle fill={resolvedAccent} cx="114" cy="88" r="2.2" className="thinker-pupil-glint" />
            </g>
      ...
      {id === 'gandhi' && (
        <svg viewBox="0 0 200 200" fill="none" className="w-full h-full block">
          <g stroke={resolvedStroke} opacity={resolvedGuideOpacity} strokeWidth="0.8" fill="none" className="thinker-astrolabe-guides">
      ...
      {id === 'kant' && (
        <svg viewBox="0 0 200 200" fill="none" className="w-full h-full block">
          ...
          <g className="thinker-living-body">
            ...
            {/* Living Eyes */}
            <g className="thinker-living-eyes" style={{ transformOrigin: '100px 82px' }}>
              <circle fill={resolvedAccent} cx="86" cy="82" r="2.4" className="thinker-pupil-glint" />
              <circle fill={resolvedAccent} cx="114" cy="82" r="2.4" className="thinker-pupil-glint" />
            </g>
      ...
      {id === 'mill' && (
        <svg viewBox="0 0 200 200" fill="none" className="w-full h-full block">
          ...
          <g className="thinker-living-body">
            ...
            {/* Living Eyes */}
            <g className="thinker-living-eyes" style={{ transformOrigin: '100px 80px' }}>
              <circle fill={resolvedAccent} cx="86" cy="80" r="2.2" className="thinker-pupil-glint" />
              <circle fill={resolvedAccent} cx="114" cy="80" r="2.2" className="thinker-pupil-glint" />
            </g>
